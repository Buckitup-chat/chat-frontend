<template>
	<div>
		<div class="text-secondary mb-3">Save backup file on your device, make sure to set secured password.</div>
		...
		<button type="button" class="btn btn-dark d-flex justify-content-center align-items-center w-100" @click="backup()">Download Local Backup</button>
	</div>
</template>
